...
class HomeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: isDetailedList ? double.infinity : FetchPixels.getPixelWidth(210),
      height:
          ...
          Expanded(
            child: Padding(
              padding: EdgeInsets.only(
                  right: FetchPixels.getPixelWidth(isDetailedList ? 0 : 17.0)),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  getCustomFont(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: getIconText(Icons.width_wide_outlined, "4 sqft"),
                      ),
                    ],
                  ),
                  Spacer(),
